...
[![release](https://img.shields.io/github/tag-date/traefik/yaegi.svg?label=alpha)](https://github.com/ibilllee/yaegi/releases)
[![Build Status](https://github.com/ibilllee/yaegi/actions/workflows/main.yml/badge.svg)](https://github.com/ibilllee/yaegi/actions/workflows/main.yml)
[![GoDoc](https://godoc.org/github.com/ibilllee/yaegi?status.svg)](https://pkg.go.dev/mod/github.com/ibilllee/yaegi)
...
```go
import "github.com/ibilllee/yaegi/interp"
```

### Command-line executable

```bash
go install github.com/ibilllee/yaegi/cmd/yaegi@latest
```
...
```console
$ yaegi -syscall -unsafe -unrestricted github.com/ibilllee/yaegi/cmd/yaegi
>
```
...
Go modules are not supported yet. Until that, it is necessary to install the source into `$GOPATH/src/github.com/ibilllee/yaegi` to pass all the tests.
...
[docs]: https://pkg.go.dev/github.com/ibilllee/yaegi
[license]: https://github.com/ibilllee/yaegi/blob/master/LICENSE
[github]: https://github.com/ibilllee/yaegi
[bugs]: https://github.com/ibilllee/yaegi/issues?q=is%3Aissue+is%3Aopen+label%3Abug
